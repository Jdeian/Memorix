...
public class PayMayaPayment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pay_maya_payment);
        ...
        images.add(new ImageData(R.drawable.paymaya_slide1));
        images.add(new ImageData(R.drawable.paymaya_slide2));
        images.add(new ImageData(R.drawable.paymaya_slide3));
